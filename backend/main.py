...
def addSelectedData(data:FeedList):
    ...
    mainPage=request("GET","https://script.google.com/macros/s/AKfycbxQe09M50_NutxTaBCNOXumCTgKA9R1224X-TvjNHc-NNy9XrebVBUOKTDOnaPS1FWU/exec?content="+data_to_collect['title']['url'])
    parsedMainWebPage = BeautifulSoup(mainPage.data, 'html.parser')
    print(parsedMainWebPage)
